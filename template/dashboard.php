<div class="wrap">
    ...
    <div class="wfc-tabs">
        ...
        <a href="#" class="wfc-tab-link" tab-target="#account-container">Account Management</a>
    </div>
    ...
    <div class="wfc-tabs-container">
        ...
        <div id="account-container" class="tab-container d-none">
            <?php
                include_once(WFC_PLUGIN_PATH . '/template/admin/account.php');
            ?>
        </div>
    </div>    
</div>
